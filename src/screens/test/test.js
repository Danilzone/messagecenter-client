...
export const TestAxios = () => {
  ...
  const othe_msg = {
    "id": "a511c6c8-bf30-400d-bb16-a53f570f201d",
    "version": "v3.0.0",
    "timestamp": 1716230879,
    "payload": {
        "type": "message",
        "value": {
            "id": "670add77d13c0740dda565dd88c33bb1",
            "chat_id": "u2u-fUou7m2QprJtGcB9WIaSCw",
            "user_id": 159470220,
            "author_id": 159470220,
            "created": 1716230878,
            "type": "text",
  ...
  const my_msg = {
    "id": "1227afc2-cede-42ea-90b6-70b213ec4d2e",
    "version": "v3.0.0",
    "timestamp": 1716153906,
    "payload": {
        "type": "message",
        "value": {
            "id": "381574efe05b226a00de7fd152af98f8",
            "chat_id": "u2u-ZvYIW8c5Fzps3~AAlgzZVw",
            "user_id": 159470220,
            "author_id": 159470220,
            "created": 1716153906,
            "type": "text",
...
const ws_chat_id = my_msg.payload.value.chat_id
const ws_message = my_msg.payload.value.content.text

const ws_chat_id_o = othe_msg.payload.value.chat_id
const ws_message_o = othe_msg.payload.value.content.text

  return (
    <div>
      <h1>Messages:</h1>
      <ul>
        {ws_chat_id} - {ws_message}
        {ws_chat_id_o} - {ws_message_o}
      </ul>
    </div>
  );
}